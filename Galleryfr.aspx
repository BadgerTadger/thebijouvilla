<%@ Page Title="Galerie" Language="C#" MasterPageFile="~/SiteFr.master" AutoEventWireup="true" CodeFile="GalleryFr.aspx.cs" Inherits="Gallery" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="footer">
        <table cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
                <td></td>
                <td colspan="3" class="gris11" style="text-align: center"><a href="Gallery2Fr.aspx">Page 2&nbsp;&gt;&gt;</a></td>
            </tr>
        </table>
    </div>
</asp:Content>
